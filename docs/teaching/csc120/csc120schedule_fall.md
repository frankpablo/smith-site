...
# Schedule for CSC 120 Fall 2026
...
|------------|-----------|---------|------------|-----------|
| 09/09      | L1: Class Intro |  | A1 (before L2) |  |

# Week 02: Intro
| **Date**   | **Topic** | **Due** | **Issued** | **Notes** |
|------------|-----------|---------|------------|-----------|
| 09/14      | L2: VS Code, git, and OO intro |  A1 |    | |
| 09/16      | L3: Object-Oriented Programing |     | A2 (before L5) | |
...
| 09/30 | L9: Association | A4 | A5 (before L11) |  |

# Week 06: More OO-Concepts
| **Date**   | **Topic** | **Due** | **Issued** | **Notes** |
|------------|-----------|---------|------------|-----------|
| 10/05 | L10: Handling Exceptions |   |  |   |
| 10/07 | L11: SW Eng Skill: Unit Testing | A5 | A6 (before L12) |  |

# Week 07: Applications and Recap
| **Date**   | **Topic** | **Due** | **Issued** | **Notes** |
|------------|-----------|---------|------------|-----------|
| 10/05 | L12*: Real-World Application: Introduction to Graphics |   |  |   |
| 10/07 | L13*: Mid-semester Recap  | A6 |  |  |

...
\collaborators}
\rhead{CSC250 Spring 2026 - Assignment 5\\
\today{}}
\cfoot{p. \thepage}
...
\end{center}
Give the sequence of configurations (sequence of states) that $M$ enters when started on each of the following strings:
\begin{enumerate}[(a)]
	\item 0
	% -------------------------------------------

...
\collaborators}
\rhead{CSC250 Spring 2026 - Homework 02\\
\today{}}
\cfoot{p. \thepage}
...
\begin{enumerate}
    ...
    \item \textbf{Induction Step}: Using the hypotheses ($L_1$ and $L_2$ are reversible into Regular languages), show that the reverse of \textbf{any} regular expression is also a regular expression (
    the reverse of \texbf{any} regular expressions that use alternation, concatenation, and Kleene star are also regular expressions);
\end{enumerate}

...
\collaborators}
\rhead{CSC250 Spring 2026 - Assignment 3\\
\today{}}
\cfoot{p. \thepage}
...
\begin{itemize}
    ...
    \item then remove, from that set, the subset of words that have exactly two ones;
    \item then remove, from that set, the subset of words that have an even number of zeros and no ones;
\end{itemize}
...
\begin{itemize}
    ...
    \item add, to that set, all the words that have exactly two ones;
    \item then add, to that set, all the words that have an even number of zeros;
\end{itemize}
...
\textit{Hint: try induction on the length of the word!}
\end{exercise}
